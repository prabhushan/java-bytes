 ...
 */
package com.java.bytes.lesson3;
...
public class RandomWords {
	...
	public List<String> createList(int listSize) {
		...
		List<String> wordList = rand.ints(listSize,0,allWords().size()).mapToObj(sourceWords::get).collect(Collectors.toList());
	...
	public static void main(String[] args) throws IOException {
		...
		random.createList(5).stream().forEach(System.out::println);
	}
}